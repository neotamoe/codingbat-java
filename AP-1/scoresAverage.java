...
//  length/2. The array length will be at least 2. To practice decomposition, write a
// separate helper method int average(int[] scores, int start, int end) { which
// computes the average of the elements between indexes start..end. Call your helper
// method twice to implement scoresAverage(). Write your helper method after your
